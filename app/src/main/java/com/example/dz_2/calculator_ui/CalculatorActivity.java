...
import com.example.dz_2.R;
import com.example.dz_2.calculator_domain.CalculatorImp;
...
public class CalculatorActivity extends AppCompatActivity implements CalculatorView {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        txtResult = findViewById(R.id.result_view);
        ...
        findViewById(R.id.key_mul).setOnClickListener(operatorsClickListener);
